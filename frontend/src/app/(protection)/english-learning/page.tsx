...
import { Plus, Search, BookOpen, Brain, MoreVertical, Trash2, LayoutGrid, List, PenLine } from "lucide-react";
...
export default function EnglishLearningPage() {
  ...
  const loadRecords = async () => {
    try {
      setLoading(true);
      const data = await fetchEnglishRecords({ search, type: filterType || undefined });
      setRecords(data);
    } catch (error) {

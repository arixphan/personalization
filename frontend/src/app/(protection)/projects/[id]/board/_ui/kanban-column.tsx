...
const KanbanColumnComponent: React.FC<KanbanColumnProps> = ({
  ...
  return (
    <div
      ref={setNodeRef}
      className={`flex-1 min-w-[140px] xs:min-w-[200px] sm:min-w-[280px] lg:min-w-[300px] h-full flex flex-col ${
        theme === 'dark' ? 'bg-gray-800/30' : 'bg-gray-50'
      } rounded-xl select-none transition-all duration-300 snap-center`}
    >

...
export class UserController {
  ...
  updateExperience(
    @Request() req,
    @Body() experienceDto: UpdateUserExperienceDto,
  ) {
    return this.userService.updateProfile(req.user.sub, {
      experience: JSON.stringify(experienceDto),
    });
  }
  ...
  updateEducation(
    @Request() req,
    @Body() educationDto: UpdateUserEducationDto,
  ) {
    return this.userService.updateProfile(req.user.sub, {
      education: JSON.stringify(educationDto),
    });
  }
  ...
  updateSkills(@Request() req, @Body() skillDto: UpdateUserSkillDto) {
    return this.userService.updateProfile(req.user.sub, {
      skills: JSON.stringify(skillDto),
    });
  }
}
